...
object LocalGameData {
    val targets = listOf(
        SoundTarget("s", "SSSS", "S", "/s/", "Cobra", "Som da cobra", false, "🐍", "Floresta da Cobra", listOf("sapo", "sopa", "saco", "sapato", "sino", "sumo", "selo", "sala", "caça", "doce", "preço")),
        SoundTarget("z", "ZZZZ", "Z", "/z/", "Abelha", "Som da abelha", true, "🐝", "Colmeia da Abelha", listOf("zero", "zumbido", "zelo", "azeite", "casa", "mesa", "asa", "rosa", "doze", "preso")),
        SoundTarget("x", "CHHHH", "X/CH", "/ʃ/", "Chuva", "Som da chuva", false, "🌧️", "Nuvem da Chuva", listOf("chuva", "chá", "chave", "chapéu", "chato", "queixo", "peixe", "mochila", "lixo", "caixa")),
        SoundTarget("j", "JJJJ", "J", "/ʒ/", "Joaninha", "Som da joaninha", true, "🐞", "Jardim da Joaninha", listOf("já", "janela", "jogo", "joaninha", "jardim", "jato", "queijo", "gelo", "girafa")),
    )

    val minimalPairs = listOf(
    ...
    val stickers = listOf(
        "Cobra construtora", "Abelha mineira", "Nuvem sorridente", "Joaninha exploradora",
        "Picareta dourada", "Baú de estrelas", "Cristal do S", "Cristal do Z",
        "Cristal do X", "Cristal do J", "Portal dos sons", "Castelo completo",
    )

    val phraseHints = mapOf(
